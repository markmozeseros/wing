				...
				<div className="container">
					<div className="row align-items-end mb-10">
						<div className="col-md-8">
							<h3 className="neutral-1000 wow fadeInUp">{t('carsListing2.title')}</h3>
							<p className="text-lg-medium neutral-500 wow fadeInUp">{t('carsListing2.subtitle')}</p>
						</div>
								...
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
										...
										<div className="card-right">
											<span className="rating text-xs-medium py-1 rounded-pill">4.96 <span className="text-xs-medium neutral-500">(672 {t('common.reviews')})</span></span>
										</div>
									</div>
									...
									<div className="card-program">
										...
										<div className="endtime">
											...
											<div className="card-button"><Link className="btn btn-gray" href="/cars-details-2">{t('common.bookNow')}</Link></div>
										</div>
									</div>
								</div>
							</div>
