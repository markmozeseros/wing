				...
				<div className="container">
					<div className="row align-items-end">
						<div className="col-md-9 wow fadeInUp">
							<h3 className="title-svg neutral-1000 mb-5">{t('carsListing1.title')}</h3>
							<p className="text-lg-medium text-bold neutral-500">{t('carsListing1.subtitle')}</p>
						</div>
								...
								<div className="swiper-wrapper">
									<SwiperSlide>
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-1/car-1.png" alt="VING" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
													...
													<div className="card-right">
														<span className="rating">4.96 <span className="text-sm-medium neutral-500">(672 {t('common.reviews')})</span></span>
													</div>
												</div>
												...
												<div className="card-program">
													...
													<div className="card-facitlities">
														<p className="card-miles text-md-medium">25,100 {t('common.miles')}</p>
														<p className="card-gear text-md-medium">{t('common.automatic')}</p>
														<p className="card-fuel text-md-medium">{t('common.diesel')}</p>
														<p className="card-seat text-md-medium">7 {t('common.seats')}</p>
													</div>
													<div className="endtime">
														<div className="card-price">
															<p className="text-md-medium neutral-500 me-2">{t('common.from')}</p>
															<h6 className="heading-6 neutral-1000">$498.25</h6>
														</div>
														<div className="card-button"><Link className="btn btn-gray" href="/cars-details-1">{t('common.bookNow')}</Link></div>
													</div>
												</div>
											</div>
										</div>
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-1/car-2.png" alt="VING" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
									...
									<SwiperSlide>
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-1/car-3.png" alt="VING" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
										...
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-1/car-4.png" alt="VING" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
									...
									<SwiperSlide>
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-1/car-5.png" alt="VING" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
										...
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/cars-details-1">
													<img src="/assets/imgs/cars-listing/cars-listing-1/car-6.png" alt="VING" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
