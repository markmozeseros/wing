							...
							<div className="col-lg-7 col-md-6 text-center text-md-end mt-md-0 mt-4">
								<div className="d-flex align-items-center justify-content-center justify-content-md-end">
									<form className="form-newsletter wow fadeInUp" action="#">
										<input className="form-control" type="text" placeholder={t('footer.subscribePlaceholder')} />
										<input className="btn btn-brand-2" type="submit" defaultValue={t('footer.subscribeBtn')} />
									</form>
								</div>
							</div>
						</div>
						...
						<div className="col-md-3 col-sm-12 footer-1">
							<div className="mt-20 mb-20">
								...
								<div className="box-info-contact mt-0">
									...
									<p className="text-md neutral-400 icon-email">{t('footer.email')}</p>
								</div>
					...
					<div className="footer-bottom mt-50">
						<div className="row align-items-center justify-content-center">
							<div className="col-md-6 text-md-start text-center mb-20">
								<p className="text-sm color-white">© {new Date().getFullYear()} {t('footer.copyright')}</p>
							</div>
