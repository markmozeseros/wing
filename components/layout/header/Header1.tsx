				...
				<div className="top-bar top-bar-2 top-bar-3 bg-transparent">
					<div className="container-fluid">
						<div className="text-header-info">
							<Link className="phone-head text-white" href="tel:+36708025000">
								...
								<span className="d-none d-lg-inline-block">+36 70 802 5000</span>
							</Link>
							<Link className="email-head text-white" href="mailto:operation@hydrahorizon.com">
								...
								<span className="d-none d-lg-inline-block">operation@hydrahorizon.com</span>
							</Link>
						</div>
						<div className="text-header">
						<div className="text-unlock text-sm-medium text-white">{t('nav.headerPromo')}</div>
							<Link className="btn btn-brand-2 btn-small text-dark px-3 py-2 text-xs-medium " href="/cars-list-1">
								{t('nav.accessNow') || 'Access Now'}
						...
						<div className="top-right-header">
							<Dropdown className="d-none d-xl-inline-block box-dropdown-cart align-middle mr-15 head-lang">
								<Dropdown.Toggle id="header1-lang-toggle" as="span" className="text-14-medium icon-list icon-account icon-lang">
							...
							<div className="header-nav">
								<nav className="nav-main-menu">
									<ul className="main-menu">
										<li><Link className="color-white" href="/">{t('nav.home')}</Link></li>
										<li><Link className="color-white" href="/cars-list-1">{t('nav.vehicles')}</Link></li>
										...
										<li className="has-children arrow-white">
											<Link className="color-white" href="#">{t('nav.pages')}</Link>
											<ul className="sub-menu">
										...
										<li><Link className="color-white" href="/contact">{t('nav.contact')}</Link></li>
									</ul>
								</nav>
							</div>
